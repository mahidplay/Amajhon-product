...
const Product = () => {
    ...
    const {id,price,rating,stock,thumbnail,title,images} = product

    return (
        <div className="flex h-full py-20  justify-center items-center ">
            
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img className="p-8 rounded-t-lg h-60 w-full" src={thumbnail} alt="product image" />
            </a>
